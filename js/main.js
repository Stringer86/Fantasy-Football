(function() {
  ...
  function getPhoto1() {
    ...
    if ($search.length === 0) {
       Materialize.toast('Please input a player!', 4000);
       return;
    }
    ...
    $xhr.done(function(data) {
      ...
      $player1.remove();
      $labels.remove();
      $left.append(`<h5>${fullName}</h5>`);
      $button.remove();
      $container.append(`<div class="row"><div class="col l6 offset-l5"><a class="#37474f blue-grey darken-3 btn" id="button2">New decision</a></div></div>`);
